...
public class AppTest {
    ...
    void testGetPerson(int id) throws Exception {
        MockHttpServletResponse responseGet = mockMvc
                .perform(get("/people/" + id))
                .andReturn()
                .getResponse();
        assertThat(responseGet.getStatus()).isEqualTo(MockHttpServletResponse.SC_OK);
        assertThat(responseGet.getContentType()).isEqualTo(MediaType.APPLICATION_JSON_VALUE);
    }
    ...
    void testPatchPerson() throws Exception {
        MockHttpServletResponse responsePatch = mockMvc
                .perform(patch("/people/1")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content("{\"firstName\":\"Ilya\", \"lastName\":\"Ostapenko\"}"))
                .andReturn()
                .getResponse();
        ...
        assertThat(responsePatch.getStatus()).isEqualTo(MockHttpServletResponse.SC_OK);
    ...
    void testDeletePerson() throws Exception {
        ...
        assertThat(responseDelete.getStatus()).isEqualTo(MockHttpServletResponse.SC_OK);
