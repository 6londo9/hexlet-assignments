...
class AppTest {
    ...
    void testRegistration() throws IOException, ParseException {
        ...
        param.add(new BasicNameValuePair("firstName", "Ilya"));
        param.add(new BasicNameValuePair("lastName", "Ostapenko"));
        param.add(new BasicNameValuePair("email", "qwerty@gmail.com"));

        getRequest.setEntity(new UrlEncodedFormEntity(param));
