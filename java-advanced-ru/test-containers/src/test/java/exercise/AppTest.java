...
public class AppTest {
    ...
    void testGetPersons() throws Exception {
        ...
        assertThat(responseGet.getContentAsString()).contains("Doe");
        assertThat(responseGet.getContentAsString()).contains("Simpson");
        assertThat(responseGet.getContentAsString()).contains("Lock");
    }

    @Test
    void testGetSpecificPerson() throws Exception {
        MockHttpServletResponse responseGet = mockMvc
                .perform(
                        get("/people/1")
                ).andReturn().getResponse();
